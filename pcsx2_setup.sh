...
LINK="$HOME/.config/PCSX2"
API_URL="https://api.github.com/repos/PCSX2/pcsx2/releases"
ICON_URL="https://raw.githubusercontent.com/PCSX2/pcsx2/master/bin/resources/icons/AppIconLarge.png"
DESKTOP_FILE="$DESKTOP_DIR/pcsx2.desktop"
...
for r in releases:
    for a in r.get('assets', []):
        name = a['name'].lower()
        if 'linux' in name and name.endswith('.appimage'):
...
if [ -z "$APPIMAGE_NAME" ]; then
    echo "❌ Could not find PCSX2 AppImage in $INSTALL_DIR."
    sleep 10
    exit 1
fi
...
mkdir -p "$ICON_DIR"
curl -L "$ICON_URL" -o "$ICON_DIR/pcsx2.png"
...
rm -f "$DESKTOP_DIR"/pcsx2*.desktop
rm -f "$DESKTOP_DIR"/PCSX2*.desktop
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
if [ "$NEEDS_DOWNLOAD" = true ]; then
    echo "   🎮 PCSX2 $LATEST_VERSION installed!"
else
    echo "   🎮 PCSX2 is already up to date!"
fi
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
